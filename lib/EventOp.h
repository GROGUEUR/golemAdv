/**
* \file EventOp.h
* \brief programme gérant les évènements
* \author Luka Cognard.
* \version 1.9.5
* \date 16 Avril 2024.
*/
...
*/
void ReactEventsOp(int,int,int*,SDL_Renderer* ,SDL_Texture*,SDL_Rect marcheHori[3][8],SDL_Rect* ,int*,int,int,team_t,int biome,int,int*,int[125][250],SDL_Texture * vendeurDialoTexture[5],int * map,SDL_Rect* savedest,int numperso);
...
void EventShop(int *MouseOver,int *Action,SDL_Renderer* pRenderer,int biome,equipement_t allStuff[ALL_EQUIPEMENTS][3],inventaire_t* inv,int w,int h,scene_t* scene,objet_t allPot[ALL_OBJETS],int*);
